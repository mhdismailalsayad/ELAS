...
import os
import jellyfish
from Keyword_Extractor.utils.Levenshtein import Levenshtein
from Keyword_Extractor.utils.datarepresentation import DataCore
...
class KeywordExtractor(object):
    def __init__(
        ...
        self.stopword_set.update(self.additional_stopwords)
